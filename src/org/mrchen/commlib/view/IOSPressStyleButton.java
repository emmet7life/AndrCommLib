...
public class IOSPressStyleButton extends Button {
	private Bitmap mHighlightBitmap = null;
	private Drawable mDefaultBackgroud = null;

	public IOSPressStyleButton(Context context) {
		super(context);
	}

	public IOSPressStyleButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public IOSPressStyleButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	/**
	 * 如果视图的Text发生了变化，则要调用此方法重置
	 */
	public void reset() {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (mHighlightBitmap == null) {
			...
			mHighlightBitmap = Bitmap.createBitmap(pixels, w, h, Bitmap.Config.ARGB_8888);
