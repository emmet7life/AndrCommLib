...
public abstract class SyncHttpClient extends AsyncHttpClient {
	...
	/*
	 * as this is a synchronous request this is just a helping mechanism原理、机制 to
	 * pass the result back to this method. Therefore the result object has to
	 * be a field to be accessible
	 */
	...
	protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest,
		...
		/*
		 * will execute the request directly 直接运行任务
		 */
